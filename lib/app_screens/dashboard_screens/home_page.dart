...
import 'package:pluto_app_assignment/app_screens/dashboard_screens/bookmarked_tracks_screen.dart';
import 'package:pluto_app_assignment/app_screens/dashboard_screens/search_screen.dart';
        ...
        return Scaffold(
              ...
              IconButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (ctx) => const BookmarkedTracksListPage()),
                  );
                },
                icon: Icon(
          ...
          body: RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (ctx, index) {
                MusicTrackModel event = state.listOfEvents![index];
